...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (a,b) -> a < b ? 1 : -1;
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((a,b)->a.getBudget()<b.getBudget() ? 1 : -1).limit(3).map(b -> b.getName());
    ...
    public void distinctAge() {
         ...
         */
        Stream<Integer> distinctAgeStream = customerList.stream().map(e -> e.getAge()).distinct();
